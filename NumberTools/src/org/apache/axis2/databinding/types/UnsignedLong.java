 ...
 * 
 * @see <a href="http://www.w3.org/TR/xmlschema-2/#unsignedLong">XML Schema 3.3.21
 */
public class UnsignedLong extends Number implements Comparable<Object> {
	...
	public UnsignedLong(String stValue) throws NumberFormatException {
		...
		// Once encoded into binary, it is to late to detect that the client intended a negative integer.
		...
		try {
			...
			throw new NumberFormatException("An empty string is not a valid representation of a UnsignedLong.");
		}
	}
	...
	public static boolean isValid(BigInteger value) {
		...
		// if this BigInteger is too big to git in a long, only the low-order 64 bits are returned.
	...
	public synchronized boolean equals(Object obj) {
		...
		__equalsCalc = obj;
		boolean _equals = ((lValue == null && other.lValue == null) || (lValue != null && lValue.equals(other.lValue)));
		__equalsCalc = null;
		return _equals;
	}
	...
	/**
	 * @return the value 0 if the argument is a UnsignedLong numerically equal to this
	 ...
	 *         if thatLong is a long numerically greater than thisLong; ang a value greater than 0
	...
	private static int compare(long thisLong, long thatLong) {
		...
		if (thisLong == thatLong) {
			...
			boolean isLessThan; // This is less that that.
